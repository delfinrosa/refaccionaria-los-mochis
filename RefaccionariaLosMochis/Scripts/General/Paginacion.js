...
function configurarPaginacion(paginaActual, totalPaginas, onPaginaCambiada, tipo, numElementosPorPagina) {
    var lblPagina;
    var IdSpan;
    ...
    var opcionesLista = $('<div class="d-flex align-items-center">' +
        ...
        '<select class="form-select w-auto" id="' + cboElementos + '">' +
    ...
    $('#' + cboElementos + '').change(function () {
        ...
        if (tipo == "B") {
            ...
            division = obtenerDivision($('#txtBusquedaNuevo').val().toLowerCase(), $('#' + cboElementos + '').val())
        } else {
