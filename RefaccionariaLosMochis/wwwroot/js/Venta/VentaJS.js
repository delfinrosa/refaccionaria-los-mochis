...
$('#btnEnviar').on('click', function () {
    ...
    swal({
        ...
        function (inputValue) {
            ...
            JQueryAjax_Normal('/Venta/GuardarVenta', { listaVentasProductos: listaVentasProductos, nombre: inputValue.toUpperCase(), factura: $("#checkFiltros").prop('checked') }, false, function (data) {
                if (data.bien) {
...
//            JQueryAjax_Normal('/Venta/InformacionTicket', { idVenta: idVenta }, false, function (data) {
//                //$("#print-button").addClass("d-none");
//                //$("#DivTicket").addClass("d-none");

//                // Cargar los datos generales del ticket (basados en el primer producto)
//                var venta = data.data[0];
//                $('#fecha').text(new Date(venta.fecha).toLocaleDateString());
//                $('#nombreCliente').text(venta.nombreCliente);
//                $('#vendedor').text(venta.vendedor);

//                // Agregar todos los productos a la tabla y calcular el total
//                var total = 0;
...
//<td>${((producto.precio * producto.cantidad) * 0.84).toFixed(2)}</td>
//                    <td>${(producto.precio * producto.cantidad).toFixed(2)}</td>
//                </tr>
//            `;
//                    $('#detalle-productos').append(row);
...
//                if (data.codigo) {
//                    $('#barcodeImage').attr('src', 'data:image/png;base64,' + data.codigo);
//                }
