...
function llenarTabla(tabla) {
    ...
    $.each(tabla, function (index, item) {
        var row = $("<tr>");
        row.append($("<td>").text(item.Item1));
        row.append($("<td>").text(item.Item2));
        row.append($("<td>").text(item.Item3));
        row.append($("<td>").text(item.Item4));
...
$("#tabla tbody").on("click", '.btn-aprobar', function () {
    ...
    swal({
        ...
        function () {
            JQueryAjax_Normal('/Compras/AprobarCompra', { compraId: marca.Item1 }, true, function (data) {
                setTimeout(function () {
...
$("#tabla tbody").on("click", '.btn-cancelar', function () {
    ...
    swal({
        ...
        function (inputValue) {
            ...
            JQueryAjax_Normal('/Compras/CancelarCompra', { compraId: marca.Item1, comentario: inputValue }, true, function (data) {
                setTimeout(function () {
                    swal("Estatus Compra", data.Mensaje, "success")
                }, 250);
                cargartabla()
...
$("#tabla tbody").on("click", '.btn-eliminar', function () {
    ...
    swal({
        ...
        function () {
            JQueryAjax_Normal('/Compras/EliminarCompra', { compraId: marca.Item1 }, true, function (data) {
                setTimeout(function () {
...
$("#tabla tbody").on("click", '.btn-ver', function () {
    var rowIndex = $(this).closest("tr").index();
    var idCompra = dataTabla[rowIndex].Item1;
