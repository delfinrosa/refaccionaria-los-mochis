...
function Guardar() {
    ...
    var Cliente = {
        ...
        oUsuario: {
            UsuarioId: 0 // Asume un valor fijo, necesitarás ajustarlo según la implementación
        }
    };
...
function DesplegarInformacionCliente(json) {
    ...
    if (json != null && json.lista != null) {
        ...
        console.log(json.lista.oCFDIRegimenFiscal.cfdiRegimenFiscalId)
        ...
        if (lista.length > 0) {
            lista.forEach(function (item) {
                ...
                listItem.on('click', function () {
                    ...
                    desplegarClientePorNombre(listItem.text());
                });
